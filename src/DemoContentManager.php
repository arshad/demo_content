...
class DemoContentManager implements DemoContentManagerInterface {
  ...
  public function __construct(DemoContentExtensionManagerInterface $extension_manager, EntityTypeManagerInterface $entity_type_manager, EntityTypeBundleInfoInterface $entity_type_bundle_info, EntityRepositoryInterface $entity_repository ,EntityFieldManagerInterface $entity_field_manager, DemoContentEntityTypeValidatorInterface $entity_type_validator, DemoContentFileManager $file_manager) {
